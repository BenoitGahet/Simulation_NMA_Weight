...
load("sim.metadataB3_B6.Donnee.250.Rdata")
...
SB3_B6_250 <- NULL
system.time(SB3_B6_250 <- foreach (i=1:NS,combine=list) %dopar% 
              {
                library(gemtc)
                library(rjags)
...
SB3_B6_250_8 <- NULL
system.time(SB3_B6_250_8 <- foreach (i=1:NS,combine=list) %dopar% 
              {
                library(gemtc)
                library(rjags)
...
SB3_B6_250_5 <- NULL
system.time(SB3_B6_250_5 <- foreach (i=1:NS,combine=list) %dopar% 
              {
                library(gemtc)
                library(rjags)
...
SB3_B6_250_1 <- NULL
system.time(SB3_B6_250_1 <- foreach (i=1:NS,combine=list) %dopar% 
              {
                library(gemtc)
                library(rjags)
...
SB3_B6_250_0 <- NULL
system.time(SB3_B6_250_0 <- foreach (i=1:NS,combine=list) %dopar% 
              {
                library(gemtc)
                library(rjags)
