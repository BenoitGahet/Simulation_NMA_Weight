...
load("sim.metadataB5_B6.Donnee.100.Rdata")
...
SB5_B6_100 <- NULL
SB5_B6_100 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SB5_B6_100_8 <- NULL
SB5_B6_100_8 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SB5_B6_100_5 <- NULL
SB5_B6_100_5 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SB5_B6_100_1 <- NULL
SB5_B6_100_1 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SB5_B6_100_0 <- NULL
SB5_B6_100_0 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
