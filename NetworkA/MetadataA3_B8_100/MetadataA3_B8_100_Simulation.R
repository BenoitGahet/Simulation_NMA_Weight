...
load("sim.metadataA3_B8.Donnee.100.Rdata")
...
SA3_B8_100 <- NULL
SA3_B8_100 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SA3_B8_100_8 <- NULL
SA3_B8_100_8 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SA3_B8_100_5 <- NULL
SA3_B8_100_5 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SA3_B8_100_1 <- NULL
SA3_B8_100_1 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SA3_B8_100_0 <- NULL
SA3_B8_100_0 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
