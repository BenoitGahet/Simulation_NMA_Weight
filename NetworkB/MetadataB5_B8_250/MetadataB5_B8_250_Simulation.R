...
load("sim.metadataB5_B8.Donnee.250.Rdata")
...
SB5_B8_250 <- NULL
SB5_B8_250 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SB5_B8_250_8 <- NULL
SB5_B8_250_8 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SB5_B8_250_5 <- NULL
SB5_B8_250_5 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SB5_B8_250_1 <- NULL
SB5_B8_250_1 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
...
SB5_B8_250_0 <- NULL
SB5_B8_250_0 <- foreach (i=1:NS,combine=list) %dopar% 
  {
    library(gemtc)
    library(rjags)
